    ...
    public partial class ReservationForm : Form
    {
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Reservation Date In must be today Or later", "Invalid Date", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else if (dOut < dIn)
                {
                    MessageBox.Show("Reservation Date Out must be same Date In and later", "invalid Date", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
        ...
        private void button_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Reservation Date Out must be same as Date In and later", "invalid Date", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
                    ...
                    {
                        MessageBox.Show("Reservation Not updated Successfully", "Error Update", MessageBoxButtons.OK, MessageBoxIcon.Error);
